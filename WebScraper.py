...
with open("housing_data.csv", "w") as csv_file:
	...
	for posting in posting_elements:
		...
		# Number of beds
		bed_elem = posting.find("div", {"class":"search-results-listings-list__item-description__characteristics-popover"})	
		#print(bed_elem)
		# Number of baths
		bath_elem =  posting.find_all("div", {"class":"search-results-listings-list__item-description__characteristics-popover"})	
		print(bath_elem)
		...
		if bed_elem is not None:
			bed_val = bed_elem.text	
			#print(bed_val)

		# if location_elem is not None:
		#	location_val = posting_price_elem.find("span")
		#	print(location_val)
